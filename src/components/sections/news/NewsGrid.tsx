...
export function NewsGrid({
  ...
  return (
    <Section>
      <Container>
        <div>
          <div className="text-sm font-semibold text-aivent-secondary">News</div>
          <h2 className="mt-2 text-3xl font-extrabold tracking-tight text-white md:text-4xl">Latest updates</h2>
        </div>
