import{a as e,n as t}from"./chunk-BneVvdWh.js";import{t as n}from"./react-B_0iYUWB.js";import{t as r}from"./jsx-runtime-D16BNjX-.js";import{n as i,t as a}from"./cn-nhk1yNpb.js";function o(e,t){if(!t)return e;let n=Array.isArray(e)?[...e]:{...e},r=n;for(let n of Object.keys(t)){let i=t[n];if(i===void 0)continue;let a=e[n];if(Array.isArray(a)&&Array.isArray(i)){r[n]=i;continue}if(a&&typeof a==`object`&&!Array.isArray(a)&&i&&typeof i==`object`&&!Array.isArray(i)){r[n]=o(a,i);continue}r[n]=i}return n}var s=t((()=>{})),c,l=t((()=>{c={header:{ctaLabel:`Get Tickets`,openMenuAriaLabel:`Open menu`,menuTitle:`MENU`,closeMenuAriaLabel:`Close menu`,nav:{home:`Home`,about:`About`,speakers:`Speakers`,schedule:`Schedule`,tickets:`Tickets`,news:`News`,contact:`Contact`}},footer:{brand:`BanLi`,description:`BanLi UI — a reusable React component library with Storybook.`,columns:{event:`Event`,resources:`Resources`},links:{about:`About`,speakers:`Speakers`,schedule:`Schedule`,tickets:`Tickets`,news:`News`,contact:`Contact`},rights:`All rights reserved.`,builtWith:`Built with React + Tailwind + Storybook.`},hero:{badge:`BanLi UI`,primaryCta:`Get Started`,secondaryCta:`View Components`},sections:{whyAttend:{eyebrow:`Why Attend`,title:`What you’ll gain`},speakers:{eyebrow:`Speakers`,title:`Meet the visionaries`},schedule:{eyebrow:`Schedule`,title:`Plan your experience`},tickets:{eyebrow:`Tickets`,title:`Choose your pass`,subtitle:`Pricing for teams, builders, and leaders. Upgrade anytime.`,popular:`Popular`,buyPrefix:`Buy`,style2Title:`Ticket Style 2`,style2Subtitle:`A compact layout suitable for checkout-style sections.`,select:`Select`,cart:`Cart`,vat:`VAT`,total:`Total`,checkout:`Checkout`},news:{eyebrow:`News`,title:`Latest updates`},contact:{eyebrow:`Contact`,title:`Let’s talk`,intro:`Questions about BanLi UI? Leave a message and we’ll get back to you.`}},contactForm:{fields:{name:`Name`,email:`Email`,message:`Message`},placeholders:{name:`Your name`,email:`you@example.com`,message:`How can we help?`},errors:{nameRequired:`Name is required`,emailRequired:`Email is required`,emailInvalid:`Email format is invalid`,messageRequired:`Message is required`},submit:{sending:`Sending…`,send:`Send Message`},helper:`Submitting will call the onSubmit callback so you can wire up your API.`},contactInfo:{locationLabel:`Website`,emailLabel:`Author`,phoneLabel:`Contact`}}}));function u({messages:e,children:t}){let n=f.useMemo(()=>({messages:o(c,e)}),[e]);return(0,p.jsx)(m.Provider,{value:n,children:t})}function d(){return f.useContext(m).messages}var f,p,m,h=t((()=>{f=e(n(),1),s(),l(),p=r(),m=f.createContext({messages:c}),u.__docgenInfo={description:``,methods:[],displayName:`AiventI18nProvider`,props:{messages:{required:!1,tsType:{name:`signature`,type:`object`,raw:`{
